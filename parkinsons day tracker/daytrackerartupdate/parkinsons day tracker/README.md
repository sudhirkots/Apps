...
The three illustrations are one set: the same woman in the same chair, attempting the same thing —
getting out of it. Red heaves on the armrests and stays put, yellow is already up and smiling,
green is flung about while still seated. Only the ease changes, so the patient compares like with
like.
...
assets/               illustrations, the doctor's video, icons, bundled fonts
                      each illustration has its editable vector source alongside it (.svg)
```
